...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Michael Klug"
    user-mail-address "michiklug85@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/michaelklug/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/michaelklug/bin" "/profile/bin" "/Users/michaelklug/.npm-packages/bin" "/Users/michaelklug/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
